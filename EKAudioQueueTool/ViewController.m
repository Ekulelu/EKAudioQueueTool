...
//    NSURL *url = [NSURL URLWithString:@"http://mp3.haoduoge.com/music6/2015-10-25/1445767187.mp3"];

//       self.url = [NSURL URLWithString:@"http://mp3.haoduoge.com/music6/2015-10-25/1445767187.mp3"];
    
    //10.2M
    self.url = [NSURL URLWithString:@"http://sc1.111ttt.com/2015/1/11/02/104021604195.mp3"];
